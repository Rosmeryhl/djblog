...
$consulta="SELECT * FROM etiquetas ORDER BY id ASC";
...
if($num_regs==0){
    ...
    while($registro=$ejecutar_consulta->fetch_assoc()){?>
            <tr class="gh">
                ...
                <td>
                    <?php echo $registro["nombre_etiqueta"]; ?>
                </td>

                <td >
                    <div class="edi">
                        <a class="bt" href="actualizar-etiqueta-form.php?y=<?php echo $registro["id"];?>">editar</a>
                    </div>
                    <div class="dele">
